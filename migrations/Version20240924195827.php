 ...
 */
final class Version20240924195827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD sport_id INT NOT NULL');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095AAC78BCF8 FOREIGN KEY (sport_id) REFERENCES sport (id)');
        $this->addSql('CREATE INDEX IDX_AC74095AAC78BCF8 ON activity (sport_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_AC74095AAC78BCF8 ON activity');
        $this->addSql('ALTER TABLE activity DROP sport_id');
    }
}
